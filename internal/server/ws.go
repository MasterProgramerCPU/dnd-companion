...
func (s *Server) playerOps() map[string]opFunc {
	return map[string]opFunc{
		...
		"char.hp":       s.opCharHP,
		"char.resource": s.opCharResource,
		"char.rest":     s.opCharRest,
...
func (s *Server) dmOps() map[string]opFunc {
	return map[string]opFunc{
		...
		"bestiary.save":     s.opBestiarySave,
		"bestiary.remove":   s.opBestiaryRemove,
		"item.save":         s.opItemSave,
		"item.remove":       s.opItemRemove,
		"item.give":         s.opItemGive,
		"init.add_bestiary": s.opInitAddBestiary,
